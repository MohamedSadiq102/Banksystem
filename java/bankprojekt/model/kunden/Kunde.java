package bankprojekt.model.kunden;
...
public class Kunde implements Comparable<Kunde>, Serializable {
	...
	public String toString() {
		...
		ausgabe += this.adresseProperty.getValue().toString() + System.getProperty("line.separator");
	...
	public String getAdresse() {
		return this.adresseProperty.getValue().toString();
	}
